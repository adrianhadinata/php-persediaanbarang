    ...
    <body onload="print()">
        ...
        <div class="container">
            <div class='row'>
                ...
                <thead>
								<tr>
                                     <th>No.</th><th>Kode</th><th>Nama Customer</th><th>Nama Barang</th><th>Tanggal Pesan</th><th>Tanggal Pengemasan</th><th>Jumlah Barang</th><th>Estimasi Pengiriman</th>
                                </tr>
								</thead>
							<tbody>
                            ...
                            $sql = "SELECT * FROM riwayat WHERE substr(tgl_pesan,1,4)='$ambilthn'";
